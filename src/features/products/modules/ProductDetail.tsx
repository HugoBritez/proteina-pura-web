...
const ProductDetail = ({ product, onClose }: ProductDetailProps) => {
    ...
    const handleAddToCart = () => {
        addToCart({
            ...
            quantity: cantidad,
            image: product.imagen || '/placeholder.png'
        })
    ...
    return (
        <>
                                ...
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="flex flex-col gap-4 mt-4">
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <button 
                                                className="flex-1 text-white px-6 py-3 rounded-lg transition-colors text-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                                                style={{ backgroundColor: config.tema.colores.primario }}
            ...
            <Notification 
                message={`${cantidad} ${cantidad === 1 ? 'unidad' : 'unidades'} de ${product.nombre} agregadas al carrito`}
